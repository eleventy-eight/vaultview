...
public class MegaInputStream {
  ...
  protected static long swigRelease(MegaInputStream obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public boolean read(String buffer) {
    return megaJNI.MegaInputStream_read(swigCPtr, this, (buffer == null) ? null : buffer.getBytes());
  }
